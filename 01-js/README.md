...
2. If you don't, you can copy these over to repl.it and run it there. Tests won't be automated there, so you will have to make use judgement to ensure if your code is correct
